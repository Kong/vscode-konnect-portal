...
import type { KonnectPortal, KonnectPortalSnippet, KonnectPortalSnippetsResponse, KonnectPortalWithRegion, MultiRegionPortalsResult, RegionFetchError } from '../types/konnect'
