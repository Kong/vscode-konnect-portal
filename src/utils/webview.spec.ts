...
describe('webview utilities', () => {
  ...
  describe('addPreviewParams', () => {
    it('should add preview params to a basic URL', async () => {
    ...
    it('should add preview params to URL with existing query parameters', async () => {
    ...
    it('should add path parameter when provided', async () => {
    ...
    it('should handle path parameter without leading slash', async () => {
      const result = addPreviewParams('https://portal.example.com', 'test-preview-id', 'docs/api')

      expect(result).toBe('https://portal.example.com/docs/api?preview=true&preview_id=test-preview-id')
    })

    it('should ignore path parameter when it is just "/"', async () => {
      const result = addPreviewParams('https://portal.example.com', 'test-preview-id', '/')

      expect(result).toBe('https://portal.example.com/?preview=true&preview_id=test-preview-id')
    })

    it('should handle URL with trailing slash and path', async () => {
    ...
    it('should handle URL with existing path and add new path', async () => {
    ...
    it('should encode preview ID properly', async () => {
    ...
    it('should handle malformed URLs gracefully with fallback', async () => {
    ...
    it('should handle malformed URL with existing query params in fallback', async () => {
    ...
    it('should handle malformed URL with path in fallback', async () => {
      const malformedUrl = 'not-a-valid-url'
    ...
    it('should encode preview ID in fallback mode', async () => {
      const malformedUrl = 'not-a-valid-url'
    ...
    it('should handle URL with port numbers', async () => {
    ...
    it('should handle multiple consecutive slashes in URL', async () => {
    ...
    it('should handle preview ID with special characters', async () => {
    ...
    it('should handle empty preview ID', async () => {
    ...
    it('should handle URL with authentication info', async () => {
